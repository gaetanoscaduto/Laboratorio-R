...
Qui una serie di ragioni per cui secondo me può valer la pena.
...
-   Poi, chiedete a ChatGPT di spiegarvi l'errore, con una formula come [questa](https://chatgpt.com/share/ef997ffe-4d29-4372-a399-94158ba7c856).
    ...
    -   Ricordate di dare più **contesto** possibile a ChatGPT nel prompt!
...
-   Sono pensate per essere utilizzate in classe per seguire la lezione o a casa per lo studio individuale, ma è **importante che teniate sempre RStudio aperto** mentre studiate, e facciate andare i comandi che vedete anche sul vostro computer!
...
-   pigreco+costante_gravitazionaleMoltiplicarle
...
-   Un vettore è una **sequenza di dati** dello stesso tipo (esempio: numerico, testuale).
...
Un DataFrame è una struttura di dati fondamentale in R. È molto simile a una tabella di dati.

-   Ogni colonna di un DataFrame può contenere un diverso tipo di dati (numerico, stringhe, ecc.), e tutte le colonne **devono avere la stessa lunghezz**a.
